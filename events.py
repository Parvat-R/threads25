...
non_tech_events = [
        ...
        "event_description": "Follow cryptic clues, decode puzzles, and race against time to uncover the hidden treasure. Strategy and teamwork will lead you to victory!"},
    {
        ...
        "event_description": "Step up to the mic and showcase your singing talent in a fun-filled music battle. No matter your genre, this is your chance to shine!"},
    {
        "event_name": "Filmography - Movie Mania",
        "event_description": "Put your film knowledge to the test! Guess movies, identify iconic scenes, and reenact dialogues in this ultimate cinematic showdown."},
    {
        "event_name": "Snap Fusion - Photography Challenge",
        "event_description": "Capture and creatively blend images based on a given theme. Show off your photography and editing skills to create stunning visual stories."},
    {
        "event_name": "Snap Fusion - Photography Challenge",
        "event_description": "Capture and creatively blend images based on a given theme. Show off your photography and editing skills to create stunning visual stories."},
    {
